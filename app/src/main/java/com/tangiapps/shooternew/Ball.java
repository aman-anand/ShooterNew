...
public class Ball {
    ...
    int index;
    int pos,rowNo;
    boolean isVisible,isBurst,isLinked;
    boolean isAvailable;
    boolean isClick;
    RectF rec=new RectF();
    ...
    Ball(double x1, double y1, int index1, boolean a,int p,int k){
        x= (float) x1;
        y= (float) y1;
        index=index1;
        isVisible=a;
        ...
        pos=p;
        //For rectangle
        rec=new RectF(x-36,y-36, x+ ballImg[index].getWidth()+36,y+ ballImg[index].getHeight()+36);
